...
public interface FlightRepository extends JpaRepository<Flight, Long> {
    ...
    @Query("SELECT new tech.filatov.pigeoner.dto.FlightDto(" +
            "f.id, f.locationName, f.distance, count(fr), f.myPassed, f.totalParticipants, f.departure, f.passingThreshold, f.flightType) " +
            ...
            "GROUP BY f.id, f.locationName, f.distance, f.myPassed, f.totalParticipants, f.id, f.departure, f.passingThreshold, f.flightType")
